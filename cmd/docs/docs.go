    ...
    "definitions": {
        ...
        "entity.AddEditProductReq": {
            ...
            "properties": {
                ...
                "name": {
                    "description": "ProductID              string                  ` + "`" + `json:\"product_id,omitempty\" example:\"when call EditProduct API\"` + "`" + `",
                    "type": "string"
                },
                "price": {
                    "type": "integer"
        ...
        "entity.WarrantPolicy": {
            ...
            "properties": {
                "warrant_description": {
                    "type": "string",
                    "example": "warrant_type: -1 lifetime,0 No-warrant policy 1 limited 2 full, WarrantTime: day unit "
                },
                "warrant_time": {
                    "type": "integer"
                },
